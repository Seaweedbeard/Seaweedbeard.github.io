...
function selectChar(name) {
    if (!player1) {
        ...
        document.getElementById("startmenu_char_selection_title").innerHTML = "<H2>" + imgp1.outerHTML + " VS " + imgp2.outerHTML + "</H2>";
        //document.getElementById("startmenu_char_selection_title").innerHTML = "<H2>" + player1.name + " vs " + player2.name + "</h2>";
