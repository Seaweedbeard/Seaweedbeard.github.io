...
function reset(type) {
  ...
  spaceship = {
    ...
    "xpos": enemy.xpos + 21,
    "ypos": 260
  }, canvas, ctx, left = false, right = false, up = false, a = false, d = false, ws = false, shooting = false, enemyshooting = false, boost = false, ogmovespeed = 2.5, movespeed, enemyboost = false;
}
...
function enemyshoot() {
  ...
  function moveenemybullet() {
    if (enemyshooting) {
      ...
      if (enemybullet.xpos >= spaceship.xpos && enemybullet.xpos <= spaceship.xpos + spaceship.width && enemybullet.ypos >= spaceship.ypos && enemybullet.ypos <= spaceship.ypos + spaceship.height || enemybullet.xpos + enemybullet.width >= spaceship.xpos && enemybullet.xpos + enemybullet.width <= spaceship.xpos + spaceship.width && enemybullet.ypos >= spaceship.ypos && enemybullet.ypos <= spaceship.ypos + spaceship.height) {
        var killplayer = function killplayer() {
...
function shoot() {
  ...
  function movebullet() {
    if (shooting) {
      ...
      if (bullet.xpos >= enemy.xpos && bullet.xpos <= enemy.xpos + enemy.width && bullet.ypos >= enemy.ypos && bullet.ypos <= enemy.ypos + enemy.height || bullet.xpos + bullet.width >= enemy.xpos && bullet.xpos + bullet.width <= enemy.xpos + enemy.width && bullet.ypos >= enemy.ypos && bullet.ypos <= enemy.ypos + enemy.height) {
